 ...
 */
public class SearchActivity extends Activity implements LoaderCallbacks<Cursor>, OnScrollListener,
	...
	public Loader<Cursor> onCreateLoader(final int id, final Bundle args) {
		...
		final String[] projection = new String[] { BaseColumns._ID,
				MediaColumns.MIME_TYPE, ArtistColumns.ARTIST,
	...
	private static final class SearchAdapter extends CursorAdapter {
		...
		public View newView(final Context context, final Cursor cursor, final ViewGroup parent) {
			return ((Activity) context).getLayoutInflater().inflate(R.layout.list_item_detailed,
					parent, false);
		}

...
public class FavoritesStore extends SQLiteOpenHelper {
	...
	public void addSongId(final Long songId, final String songName, final String albumName,
		...
		database.delete(FavoriteColumns.NAME, FavoriteColumns.ID + " = ?",
	...
	public Long getSongId(final Long songId) {
		...
		final String[] projection = new String[] { FavoriteColumns.ID, FavoriteColumns.SONGNAME,
				FavoriteColumns.ALBUMNAME, FavoriteColumns.ARTISTNAME, FavoriteColumns.PLAYCOUNT };
		final String selection = FavoriteColumns.ID + "=?";
		final String[] having = new String[] { String.valueOf(songId) };

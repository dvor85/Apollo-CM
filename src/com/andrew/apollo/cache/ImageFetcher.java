...
public class ImageFetcher extends ImageWorker {
				...
				if (PreferenceUtils.getInstance(mContext).downloadMissingArtwork()) {
					...
					if (correction != null) {
						final Album album = Album
								.getInfo(mContext, correction.getName(), albumName);
						if (album != null) {
	 ...
	 */
	public Bitmap getCachedArtwork(final String keyAlbum, final String keyArtist, final long keyId) {
		if (mImageCache != null) {
	...
	public Bitmap getArtwork(final String albumName, final long albumId, final String artistName) {
		...
		if (artwork == null && albumName != null && mImageCache != null) {
			artwork = mImageCache.getBitmapFromDiskCache(generateAlbumCacheKey(albumName,
					artistName));
		}
	...
	public static String generateAlbumCacheKey(final String albumName, final String artistName) {
		...
		return new StringBuilder(albumName).append("_").append(artistName).append("_")
				.append(Config.ALBUM_ART_SUFFIX).toString();
	}
}

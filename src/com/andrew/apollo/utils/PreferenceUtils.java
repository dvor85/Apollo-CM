...
public final class PreferenceUtils {
	...
	/**
	 * @param value
	 *            True if the user only wants to download images on Wi-Fi, false
	 *            otherwise
	 */
	 ...
	 *            The {@link Context} to use
	 * @param value
	 *            True if the user only wants to download missing album covers,
	 *            false otherwise.
	 */
	 ...
	 *            The {@link Context} to use
	 * @param value
	 *            True if the user only wants to download missing artist images
	 *            , false otherwise.
	 */
	...
	/**
	 * @param value
	 *            True if the user has checked to use lockscreen controls, false
	 *            otherwise.
	 */
